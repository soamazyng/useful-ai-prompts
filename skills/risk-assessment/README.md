...
Há também um template em [`templates/process-template.md`](templates/process-template.md) com a estrutura pronta do registro de riscos (risk register) usada pela skill.
